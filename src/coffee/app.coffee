...
Project = (project) ->
  @project = project
  @tasklists = tasklists.filter (x) -> x.projectId == project.id
  for x,y of tasklists  
    x.tasks = tasks.filter (z) -> z.taskListId == x.taskListId
  @upcomingTasks = 6
  # @addList = (->
